...
st.write("Enter a news snippet below to classify it into: **World, Sports, Business, or Sci/Tech**.")
    ...
    if not user_text.strip():
        ...
        with st.spinner("Analyzing..."):
            try:
                ...
                st.error("The API is taking a while to respond (the server might be waking up from sleep). Please try again!")
